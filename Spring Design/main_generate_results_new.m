...
for m=1:2
    ...
    for k=1:Ntest
        ...
        xlabel('f1','Fontname','Times New Roman','fontsize',18);
        ylabel('f2','Fontname','Times New Roman','fontsize',18);
...
%                 'Orientation','horizontal','fontsize',10);
        lo=legend({'NSGA-II','DEMO','MOEA/D','MOPSO','MOFPA','MOBA','MOGWO','MOMVO','MOWCA','SHAMODE','SHAMODE-WO',...
    'MSSA','RPBILDE','UPS-EMOA','MOJS','Reference Pareto'},'fontsize',12,'Fontname','Times New Roman','NumColumns',2);
%         set(lo,'position',[0.45,0.58,0.4,0.3]);
        axis tight;
%         axis([3 10 0.8E5 1.8E5]);
        print(Bfilename,'-djpeg','-r600');
        print(Bfilename,'-dmeta','-r600');
    end
end